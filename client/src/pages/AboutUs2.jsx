          ...
          <div className="row align-items-center">
            <div className="col-sm-12 col-lg-5 text-center text-lg-start">
              ...
              <h2 className="about_title">
                Welcome to Safe SheShield Empowering Women, Ensuring Safety
              </h2>
              <p className="about_text " style={{ textAlign: "justify" }}>
                At Safe SheShield, we are dedicated to creating a safer world for
          ...
          <div className="container">
            <div className="row align-items-center">
              ...
              <div className="col-sm-12 col-lg-6 text-center text-lg-start">
                ...
                <h2 className="about_title">Why Safe SheShield?</h2>
                <p className="about_text" style={{ textAlign: "justify" }}>
